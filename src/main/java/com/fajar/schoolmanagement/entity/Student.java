...
public class Student extends BaseEntity {
	...
	@Column
	@FormField(type = FieldType.FIELD_TYPE_PLAIN_LIST, availableValues = { "Laki-laki",
			"Perempuan" }, lableName = "Jenis Kelamin")
	...
	@FormField(type = FieldType.FIELD_TYPE_PLAIN_LIST, availableValues = { "Anak Kandung", "Anak Tiri",
			"Anak Adopsi" }, lableName = "Status Ananda")
	...
	@Column(name = "image_url", unique = false)
	@FormField(type = FieldType.FIELD_TYPE_IMAGE, required = false, multiple = false, defaultValue = "DefaultIcon.BMP", lableName = "Foto")
